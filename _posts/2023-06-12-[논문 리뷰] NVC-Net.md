...
- 전체적인 구조는 아래와 같음
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1ieSBcBRAB_x2_DTOqj-sIiPvz2ls2PTJ){: width="80%" height="80%"}{: .center}
...
- 합성음성과 원본 음성을 구분할 수 없도록 합성음성을 생성하기 위해서 discriminator Ladv(D(k))와 generation Ladv(Ec,Es,G)에 대한 adversarial loss는 아래와 같이 정의됨
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=11ncXoaWcoqlzATSUm6IiT8vW7mS0BVcF){: width="80%" height="80%"}{: .center}
...
- 따라서 본 연구에서는 feature matching loss를 아래와 같이 사용함
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1HIR6tPY7cgqnlbiw_M0QXDEud7qlTJMP){: width="80%" height="80%"}{: .center}
...
- speech의 특성을 보다 반영해주기 위해서 spectral loss도 추가로 사용함
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1wXs7EBcDkJA8_ebOS4nuTFik_MJESpvP){: width="80%" height="80%"}{: .center}
    ...
    - 선행 연구에 따르면 spectral loss는 spatial temporal resolution 에 따라서 FFT size를 다르게 하여 계산함. 따라서 전체적인 reconstruction loss는 모든 spectral loss들과 feature matching loss를 다 더한 값임
        ...
        ![Untitled](http://drive.google.com/uc?export=view&id=1mGF6CzOmYG6-ndVMO4I5OJMFwcoCLlUm){: width="80%" height="80%"}{: .center}
...
- converted 된 발화가 speaker의 고유한 특성을 보존하기 위해서 아래 loss를 minimize하는 쪽으로 학습함
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1SikSE4q8ua_fkE_zrUwzNzqUcjxHF2nM){: width="80%" height="80%"}{: .center}
...
- speaker의 latent space에 대해서 보다 정교한 sampling을 진행하기 위해서 speaker output distribution에 대해서 deviation을 penalize했음
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1hbnCtXzdj9eQLcqT5WtasnjNuUa7oK4f){: width="80%" height="80%"}{: .center}
...
![Untitled](http://drive.google.com/uc?export=view&id=1wbPoq4ZbOqL7itbxmg23pz__kgIyKR1y){: width="80%" height="80%"}{: .center}
...
![Untitled](http://drive.google.com/uc?export=view&id=1uR8Ob9uk6PBSTMC1dgctHMPkRqH4X98I){: width="80%" height="80%"}{: .center}
...
![Untitled](http://drive.google.com/uc?export=view&id=1Tls6Th4f9JU-uJUqV7snMR2PTkhV_n_l){: width="80%" height="80%"}{: .center}
...
- 결과
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=19CnqyXYuW8Kze_Y3GxTg0E6H7BumxGRA){: width="80%" height="80%"}{: .center}
...
- 결과
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1GQMCuvVqtO8DVPDChA_hKO4RQxQ2gU-U){: width="80%" height="80%"}{: .center}
...
- disentanglement 측정 방법
    ...
    - 결과
        ...
        ![Untitled](http://drive.google.com/uc?export=view&id=1o90_5X0KI05NdGF8nP3_yWtmByDf1sDA){: width="80%" height="80%"}{: .center}
...
- 결과
    ...
    ![Untitled](http://drive.google.com/uc?export=view&id=1dtFvQCmaYfaxlq8Eu8VmmHLL1LGklGyp){: width="50%" height="50%"}{: .center}
